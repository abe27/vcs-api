...
type Product struct {
	PRODUCTID   string      `gorm:"column:FCSKID;size:8;" json:"fcskid"  form:"fcskid"`             //FCSKID char(8) COLLATE Thai_BIN DEFAULT " " NOT NULL,
	...
	// Stock       []Stock     `gorm:"foreignKey:FCSKID;references:FCPROD"`
	// Stock       []Stock     `gorm:"foreignKey:PRODUCTID;references:FCPROD;" json:"stock,omitempty"`
